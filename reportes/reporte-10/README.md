...
![Report](https://img.shields.io/badge/Report-Week%2010-blue)
...
| Bridge | Estructural | Separación | Reportes PDF/Excel |
| Decorator | Estructural | Extensión dinámica | Notificaciones |
...
```
python
reporte = reporteInventario(formatoPDF())
reporte.crear_reporte(lista_obras)
```
...
| GET | /generar_reporte_inventario/{formato} | Generar reporte |
| POST | /notificar_obra | Generar notificación |
...
| Bridge | [Visualizar](/docs/pruebas/bridge) |
| Decorator | [Visualizar](/docs/pruebas/decorator) |
